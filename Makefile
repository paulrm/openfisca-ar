...
install: deps
	...
	@# `make install` installs the editable version of openfisca-ar.
...
build: clean deps
	...
	python -m build
	pip uninstall --yes openfisca-ar
...
test: clean
	openfisca test --country-package openfisca_ar openfisca_ar/tests

serve-local: build
	openfisca serve --country-package openfisca_ar
